...
describe('optional product data', () => {
  it('keeps Suspended compatibility and media unpublished while retaining supplied editorial copy', () => {
    ...
    expect(product?.supportedPlatforms).toEqual(['macOS Alpha', 'Linux Alpha']);
